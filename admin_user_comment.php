...
$query = "SELECT * FROM user_comment c JOIN users u ON c.user_id = u.user_id ORDER BY create_date DESC";
...
<body>
    <div id="wrapper">
        ...
        <ul id="admin_menu">
            ...
            <li><a href="admin_user_comment.php" class="active">User Comments</a></li>
        </ul> 
                ...
                <tbody>
                    ...
                    <?php while($row = $statement->fetch()): ?>
                        ...
                        <tr>
                            ...
                            <td><a id="edit-button" href="admin_user_comment_edit.php?comment_id=<?= $row['comment_id'] ?>">Edit</a></td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
